...
class GalleryState extends MusicBeatState
{
	...
	var optArray:Array<String> = ['outdated_concepts', 'music', 'bored'];
	...
	override function create()
	{
		...
		leftArrow.y = 800;
		FlxTween.tween(leftArrow, {y: leftOGY - 10}, 0.8, {
		...
		rightArrow.y = 800;
		FlxTween.tween(rightArrow, {y: rightOGY - 10}, 0.8, {
			ease: FlxEase.quartOut,
			startDelay: 0.2,
			onComplete: function(t:FlxTween)
			{
		...
		for (i in 0...optArray.length)
		{
			...
			var ogY:Float = spr.y;
			spr.y = 800;
			FlxTween.tween(spr, {y: ogY - 10}, 0.8, {
				ease: FlxEase.quartOut,
				startDelay: 0.1,
				onComplete: function(t:FlxTween)
				{
		...
		{ // intro
			...
			FlxTween.tween(barBottom, {y: FlxG.height - barBottom.height}, 0.3, {
				ease: FlxEase.quartOut,
				onComplete: function(t:FlxTween)
				{
